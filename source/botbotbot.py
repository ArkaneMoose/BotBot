            ...
            for message in messages:
                ...
                if match:
                    ...
                    self.variables.update({
                        ...
                        }) # Questionable, since there's no guarantee that the
                           # nick change succeeded, but in my opinion, the case
                           # where the nick change fails is an edge case, and
                           # this will behave as expected 99% of the time.
                    continue
